...
Esse é um projeto de minha autoria onde é possível utilizar uma calculadora virutal. Apesar de simples e fácil de desenvolver esse foi o projeto que mais gostei pois nunca tinha feito algo semelhante. 
...
```bash
# Clonar repositório
git clone https://github.com/devworkleo/calculator
...
git calculator -b feature/sua-feature ou git calculator -b bugfix/seu-bug
